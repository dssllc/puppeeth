...
export default function About() {
  ...
  return (
    ...
    <Grid item xs={12} md={8} className={classes.aboutRiver}>
      ...
      <Typography className={classes.question}>What make this project unique?</Typography>
      ...
      <Typography className={classes.question}>What make a Puppee unique?</Typography>
      ...
      <Typography>For example, there are only 100 Puppees with only one number different than the others (e.g. 51111, 44344, 23222).</Typography>
      <Typography>Find a unique combination before they are all minted!</Typography>

      <Typography className={classes.question}>How many can I mint at once?</Typography>
      ...
      <Typography>We minted 11 tokens when the contract was deployed, for friends and family. All new tokens must be minted the same as all others.</Typography>
    </Grid>
    </>
  );
}
